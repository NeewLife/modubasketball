  ...
  return (
    <div className="flex flex-col items-center justify-center my-[60px]">
      <div className="flex flex-col text-center">
        <Headline type="sub" text="농구장 사진을 업로드하려면" />
        <Headline type="sub" text="로그인이 필요해요" />
      </div>
      <div className="flex flex-col text-center desktop:mt-[20px] mt-[35px]">
        <Caption text="직접 촬영 혹은 저작권을 보유하신 사진을 게시해주세요." color="text-gray-70" />
        <Caption text="모두의 농구장은 사진의 저작권에 관련한 어떠한 책임도 지지 않습니다." color="text-gray-70" />
      </div>
      <ButtonLong
        text="카카오 계정으로 로그인"
        color="text-gray-100"
        className="!bg-[#ffE500] !active:bg-[#ffE500] !hover:bg-[#ffE500] desktop:mt-[99px] mt-[92px]"
        icon={Kakao}
        onClick={onClick}
      />
    </div>
