...
import { STORY_SPECIFIED, SET_CURRENT_STORY, CURRENT_STORY_WAS_SET, STORY_CHANGED, STORY_PREPARED, PRELOAD_ENTRIES, DOCS_PREPARED, SET_INDEX, SET_STORIES, SELECT_STORY, STORY_ARGS_UPDATED, CONFIG_ERROR, STORY_MISSING, SET_CONFIG, STORY_INDEX_INVALIDATED, PREVIEW_KEYDOWN, GLOBALS_UPDATED, NAVIGATE_URL, SET_GLOBALS, SHARED_STATE_CHANGED, STORIES_COLLAPSE_ALL, STORIES_EXPAND_ALL, UPDATE_STORY_ARGS, RESET_STORY_ARGS, FORCE_REMOUNT, UPDATE_QUERY_PARAMS, TOGGLE_WHATS_NEW_NOTIFICATIONS, REQUEST_WHATS_NEW_DATA, RESULT_WHATS_NEW_DATA, SET_WHATS_NEW_CACHE, UPDATE_GLOBALS, SHARED_STATE_SET } from '@storybook/core-events';
