...
export { Dependency, EventType, Options, Payload, StorybookAddon, StorybookMetadata, TelemetryData, addToGlobalContext, computeStorybookMetadata, getPrecedingUpgrade, getStorybookCoreVersion, getStorybookMetadata, metaFrameworks, oneWayHash, sanitizeAddonName, telemetry };
