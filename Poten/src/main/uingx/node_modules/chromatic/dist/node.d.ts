...
declare const configurationSchema: ZodObject<{
    ...
    diagnostics: ZodOptional<ZodBoolean>;
    ...
    debug?: boolean;
    diagnostics?: boolean;
    junitReport?: string | boolean;
    zip?: boolean;
    autoAcceptChanges?: string | boolean;
    exitZeroOnChanges?: string | boolean;
    exitOnceUploaded?: string | boolean;
...
declare class HTTPClient {
    ...
    fetch(url: string, options?: RequestInit, opts?: HTTPClientFetchOptions): Promise<Response>;
...
declare class GraphQLClient {
    ...
    runQuery<T>(query: string, variables: Record<string, any>, { headers, retries }?: {
        headers?: {};
        retries?: number;
    }): Promise<T>;
}
...
export { Configuration, Context, Flags, GitInfo, InitialContext, Options, TaskName, getConfiguration, getGitInfo, run, runAll };
