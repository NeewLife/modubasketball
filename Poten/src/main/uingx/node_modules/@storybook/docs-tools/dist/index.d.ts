...
declare const enhanceArgTypes: <TRenderer extends Renderer>(context: StoryContextForEnhancers<TRenderer>) => _storybook_types.StrictArgTypes<_storybook_types.Args>;
